...
$(function(){
	...
	var mapping 	= (isMulti == "Y")? "inqryMulti.do" : "inqryDetail.do";
					...
					<div class="list">
						...
						<div class="transactionTable">
							<table class="tb-1">
								...
								<c:forEach var="inqry" items="${LIST}" varStatus="status">
									<input id="mngrInqryNo" type="hidden" value="${inqry.mngrInqryNo}">
									<tr>
										<td>${inqry.mngrInqryNo}</td>
										<td class="titleAlign"><a href="inqryDetail.do?MNGR_INQRY_NO=${inqry.mngrInqryNo}" class="bbscn-1">[문의]${inqry.inqrySj}</a>
											<c:if test="${COMENT_CNT[status.index] ne 0}">
												<a href="#" class="bbscn-2">[${COMENT_CNT[status.index]}]</a>
											</c:if>
										</td>
							...
							<div class="writerBtn" align="right">
								<input type="button" value="글쓰기"
									onclick="location.href='inqryInsertForm.do'">
							</div>
						</div>
					</div>
				</div>
