...
<script type="text/javascript" src="${path}/resources/js/voucher/mylist.js"></script>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR&display=swap" rel="stylesheet">
<link href="${path}/resources/css/common.css" rel="stylesheet" type="text/css">
<link href="${path}/resources/css/voucher/mylist.css" rel="stylesheet" type="text/css">
</head>
<body>
	<div id="frameOut">
		<div id="frameIn">
			...
			<div id="content">
				<div id="content_container">
					<h1>식사권 목록</h1>
					<input id="mberCode" type="hidden" value="${ mberCode }">
					<div id="voucher_big_container">
						<input type="hidden" id="selectedVoucherCode" value="">
