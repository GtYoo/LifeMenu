...
<link href="${path}/resources/css/insertPreView.css" rel="stylesheet" type="text/css">
<title>회원가입 약관</title>
...
function chk(){
	 ...
	 if(num==1){
	  ...
	  alert("개인정보 약관에 동의하셔야 회원가입을 할 수 있습니다..");
	 }
	}
    ...
    <div id="frameIn">
        ...
        <div id="content">
        	<div id="content_container">
					<form action="insertMberView" name="form" method="post">
						<table >
							<tr>
								<td>
									<p align="left" >
										<font size="5em"><b>LifeMenu 약관동의</b></font>
									</p> <br> <textarea rows="20" cols="150" style="resize: none;"readonly>
가. 수집하는 개인정보의 항목첫째, 회사는 회원가 입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
	...
	셋째, LifeMenu 아이디를 이용한 부가 서비스 및 맞춤식 서비스 이용 또는 이벤트 응모 과정에서 해당 서비스의 이용자에 한해서만 개인정보 추가수집이 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;발생할 수 있으며, 이러한 경우 별도의 동의를 받습니다.
	넷째, 성인컨텐츠, 유료/게임 등 일부 서비스 이용시 관련 법률 준수를 위해 본인인증이 필요한 경우, 아래와 같은 정보들이 수집될 수 있습니다.
		- 이름, 생년월일, 성별, 중복가입확인정보(DI), 암호화된 동일인 식별정보(CI), 휴대폰 번호(선택), 아이핀 번호(아이핀 이용시), 
		내/외국인 정보
...
나. 개인정보 수집방법회사는 다음과 같은 방법으로 개인정보를 수집합니다.
		...
		- 생성정보 수집 툴을 통한 수집
		    ...
		    <br>
		    <br>
		    <input type="checkbox" name="req"> 개인정보 수집 및 이용에동의합니다.
								</td>
							</tr>
							<tr>
								<td align="center" valign="top">
								<input type="button" class="btn" value="동의" onclick="chk()" />&nbsp;&nbsp;&nbsp; 
								<input type="button" class="btn" value="동의하지 않습니다" onclick="nochk()"  />
								</td>
							</tr>
						</table>
					</form>
